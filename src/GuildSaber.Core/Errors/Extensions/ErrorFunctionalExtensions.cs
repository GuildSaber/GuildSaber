...
namespace GuildSaber.Core.Errors.Extensions;

public static class ErrorFunctionalExtensions
{
    /// <summary>
    ...
    public static async Task<T> Unwrap<T, E>(this Task<Result<T, E>> self) where E : Error
    {
    ...
    /// <returns>The result value if the Result is successful.</returns>
    /// <exception cref="ErrorException">Thrown when the Result is a failure.</exception>
    public static T Unwrap<T, E>(this Result<T, E> self) where E : Error
        => self.IsSuccess
            ? self.Value
    ...
    public static async Task<T> UnwrapOr<T, E>(this Task<Result<T, E>> self, T defaultValue) where E : Error
    {
        var result = await self;
        return result.IsSuccess
            ? result.Value
    ...
    public static void ThrowIfError<E>(this UnitResult<E> self) where E : Error
    {
    ...
    /// <exception cref="ErrorException">Thrown when the UnitResult is a failure.</exception>
    public static async Task ThrowIfError<E>(this Task<UnitResult<E>> self) where E : Error
    {
        var result = await self;
    ...
    /// <exception cref="ErrorException">Thrown when the Result is a failure.</exception>
    public static async Task ThrowIfError<T, E>(this Task<Result<T, E>> self) where E : Error
    {
        var result = await self;
        if (result.IsFailure) throw new ErrorException(result.Error.ToString());
    }
