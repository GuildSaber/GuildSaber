...
namespace GuildSaber.Database.Contexts.Server.Migrations
{
    ...
    [Migration("20260607175747_RankedScoreDiscriminatedUnion")]
    partial class RankedScoreDiscriminatedUnion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.Guilds.Levels.Level", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "DiscordInfo", "GuildSaber.Database.Models.Server.Guilds.Levels.Level.DiscordInfo#LevelDiscordInfo", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "LinkedAccounts", "GuildSaber.Database.Models.Server.Players.Player.LinkedAccounts#PlayerLinkedAccounts", b1 =>
                        {
                            ...
                            b1.Property<decimal?>("BLNativeId")
                                .HasColumnType("numeric(20,0)");

                            b1.Property<decimal?>("DiscordId")
                                .HasColumnType("numeric(20,0)");

                            b1.Property<decimal?>("MetaPCId")
                                .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.RankedScore", b =>
                {
                    ...
                    b.HasIndex("RankedMapId", "PlayerId", "IsSelected");
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.InvalidRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.RankedScore");

                    b.Property<int>("InvalidReason")
                        .HasColumnType("integer");

                    b.HasDiscriminator().HasValue((byte)1);
                });

            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.ScoredRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.RankedScore");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Statistics", "GuildSaber.Database.Models.Server.Scores.BeatLeaderScore.Statistics#ScoreStatistics", b1 =>
                        {
                            ...
                            b1.HasDiscriminator<string>("Discriminator").HasValue("ScoreStatistics");
                        });
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.PendingRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.ScoredRankedScore");

                    b.HasDiscriminator().HasValue((byte)2);
                });

            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.PointGivingRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.ScoredRankedScore");
                    ...
                    b.HasIndex("ContextId", "PlayerId", "RawPoints", "Id")
                        .IsDescending(false, false, true, false);
                });

            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.RefusedRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.ScoredRankedScore");
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.AcceptedRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.PointGivingRankedScore");

                    b.HasDiscriminator().HasValue((byte)3);
                });

            modelBuilder.Entity("GuildSaber.Database.Models.Server.RankedScores.ValidRankedScore", b =>
                {
                    b.HasBaseType("GuildSaber.Database.Models.Server.RankedScores.PointGivingRankedScore");
            ...
            modelBuilder.Entity("GuildSaber.Database.Models.Server.Guilds.ContextMember", b =>
                {
                    ...
                    b.HasOne("GuildSaber.Database.Models.Server.Guilds.Members.Member", "Member")
                        .WithMany("ContextMembers")
