...
using PlayModeId = GuildSaber.Database.Models.RankedMaps.MapVersions.PlayModes.PlayMode.PlayModeId;

namespace GuildSaber.Database.Models.RankedMaps.MapVersions;
