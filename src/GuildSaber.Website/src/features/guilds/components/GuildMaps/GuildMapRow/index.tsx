  ...
  return (
    <Card className="py-3">
      <CardContent className="flex flex-col px-3 md:flex-row md:items-center">
        <div className="grid flex-1 grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-4 sm:grid-cols-[auto_minmax(0,1fr)_auto_auto]">
        ...
        <div className="mt-2 grid grid-cols-4 items-end gap-1 sm:grid-cols-2 md:mt-0">
          <Button
