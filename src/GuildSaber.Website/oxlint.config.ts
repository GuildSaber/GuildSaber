...
export default defineConfig({
  ...
  ignorePatterns: ["src/client/**", "src/components/ui/**"],
  rules: {
    ...
    "@stylistic/padding-line-between-statements": [
      ...
      {
        blankLine: "always",
        next: ["break", "case", "cjs-export", "class", "continue", "do", "export", "if", "switch", "try", "while", "return"],
        prev: "*",
      },
      {
        blankLine: "always",
        next: "*",
        prev: ["break", "case", "cjs-export", "class", "continue", "do", "export", "if", "return", "switch", "try", "while"],
      },
    ],
    ...
    "typescript/restrict-template-expressions": ["error", { allowBoolean: true, allowNumber: true }],
